<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="viewAnswers.aspx.cs" Inherits="viewAnswers" %>
...
<body>
    <div>
        ...
        <asp:Label ID="Label1" runat="server" BackColor="#C0FFFF" Font-Size="XX-Large" ForeColor="Red"
            Style="z-index: 101; left: 353px; position: absolute; top: 12px" Text="E Learning"
